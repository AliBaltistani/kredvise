...
Route::middleware('admin', 'adminPermission')->group(function () {
    ...
    Route::controller('UserCurrencyPermissionController')->prefix('users')->name('users.currency.')->group(function () {
        Route::get('currency-permissions/{id}', 'index')->name('permissions');
        Route::post('currency-permissions/{id}', 'update')->name('permissions.update');
        Route::get('currency-permissions/{id}/reset', 'reset')->name('permissions.reset');
    });
    
    // User Withdraw Method Permissions
    Route::controller('UserWithdrawMethodPermissionController')->prefix('users')->name('users.withdraw.method.')->group(function () {
        Route::get('withdraw-method-permissions/{id}', 'index')->name('permissions');
        Route::post('withdraw-method-permissions/{id}', 'update')->name('permissions.update');
        Route::get('withdraw-method-permissions/{id}/reset', 'reset')->name('permissions.reset');
    });
