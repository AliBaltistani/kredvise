    ...
    <div class="row gy-4">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <x-widget style="2" color="primary" icon="la la-money-bill-wave" title="Currency Permissions" value="" link="admin.users.currency.permissions" parameters="{{ $user->id }}" overlay_icon=0 icon_style=solid />
                </div>
                
                <div class="col-xxl-3 col-xl-4 col-sm-6">
                    <x-widget style="2" color="success" icon="la la-wallet" title="Withdrawal Method Permissions" value="" link="admin.users.withdraw.method.permissions" parameters="{{ $user->id }}" overlay_icon=0 icon_style=solid />
                </div>
            </div>
        </div>
